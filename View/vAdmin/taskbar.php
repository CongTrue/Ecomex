              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="./list-return.php" class="menu-link">
                    <div data-i18n="Dropdowns">Đơn rủi ro <span class="flex-shrink-0 badge bg-danger">
                    <?php 
                  $order = new order();
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="./list-congno.php" class="menu-link">
                    <div data-i18n="Perfect Scrollbar">Công nợ</div>
                  </a>
                </li>
                <li class="menu-item">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="label.php" class="menu-link">
                    <div data-i18n="Vertical Form">Upload label</div>
                  </a>
                </li>
                <li class="menu-item">
            ...
            <li class="menu-item"> 
              ...
              <ul class="menu-sub">
                ...
                <?php
                    ...
                    ?>
                <li class="menu-item">
                  <a href="list-service.php?service=<?php echo $row["name"] ?>" class="menu-link">
