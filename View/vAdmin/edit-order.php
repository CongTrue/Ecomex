                ...
                <div class="col-md-6">
                  ...
                  ?>
                    ...
                    <div class="card-body">
                      ...
                      ?>
                        <option value="6" <?php if ($result_order['trangthai'] == 6) { echo 'selected'; } ?>>Tạo nhãn label</option>
                      ...
                      <?php
                        ...
                        <?php
                          ...
                          ?>
                            <option value="5" <?php if ($result_order['trangthai'] == 5) { echo 'selected'; } ?>>Đang giao phát</option>
                            <option value="2">Đã hoàn thành</option>
                            <option value="3">Đơn rủi ro</option>
                          <?php
                        }elseif ($result_order['trangthai'] == 3){
                          ?>
                            <option value="2" <?php if ($result_order['trangthai'] == 2) { echo 'selected'; } ?>>Đã hoàn thành</option>
                            <option value="3">Đơn rủi ro</option>
                          <?php
                        }else{
                        ?>
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      ...
                      <div class="mb-3">
                        ...
                        <?php
                         if($result_order['trangthai']!=0 || $result_order['service']!=='Chưa chọn dịch vụ'){
                      ...
                      <div class="input-group" class="mb-3">
                        <input name="length"  required type="number" id="dai" <?php if($result_order['payment']==1 || $result_order['trangthai']!= 0 ){echo "readonly";} ?> min="1"  class="form-control" placeholder="Chiều dài" value="<?php echo htmlspecialchars($result_order['length']) ?>"/>
                        <input name="width"  required type="number"  id="rong" <?php if($result_order['payment']==1 || $result_order['trangthai']!= 0 ){echo "readonly";} ?> min="1"  class="form-control" placeholder="Chiều rộng" value="<?php echo htmlspecialchars($result_order['width']) ?>"/>
                        <input name="height"  required type="number"  id="cao" <?php if($result_order['payment']==1 || $result_order['trangthai']!= 0 ){echo "readonly";} ?> min="1"  class="form-control" placeholder="Chiều cao" value="<?php echo htmlspecialchars($result_order['height']) ?>"/>
                    ...
                    <div class="mb-3">
                      ...
                      <input name="weight" id="weight" type="number" step="1" min="1"  required aria-label="First name" <?php if($result_order['payment']==1 || $result_order['trangthai']!= 0 ){echo "readonly";} ?> class="form-control" placeholder="Cân nặng" value="<?php echo htmlspecialchars($result_order['weight']) ?>"/>
                    </div>
                    <div class="mb-3">
                      <label for="x2" class="form-label" >Chiết khấu (%)</label>
                      <input name="disscount" id="disscount" step="1" type="number" min="0" max="100" required <?php if($result_order['payment']==1 || $result_order['trangthai']!= 0 ){echo "readonly";} ?> class="form-control"  placeholder="Nhập chiết khấu" value="<?PHP echo $result_order['disscount'] ?>"/>
                    </div>
                    <div class="mb-3">
                      <label for="x2" class="form-label" >Phụ phí</label>
                      <input name="fee" id="fee" step="1" type="number" min="0"  required  <?php if($result_order['payment']==1 || $result_order['trangthai']!= 0 ){echo "readonly";} ?> class="form-control"  placeholder="Nhập phụ phí" value="<?PHP if($result_order['payment']==1 || $result_order['trangthai']!= 0 ){echo $result_order['fee'];} ?>"/>
                    </div>
                    <div class="mb-3">
