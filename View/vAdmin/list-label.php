			...
			<div class="card mb-3 ">
				...
				<div class="w-100">
					<table class="table table-bordered text-center mx-auto">
						...
						<tbody >
						<?php
							$selectQuery = "select * from pdf_data order by idOrder desc";
							...
							echo '<td><a href="../../pdf/' . $result['filename'] . '" class="btn btn-info" download>Tải xuống</a></td>';
							echo '<td><a onclick="return confirm(\'Bạn có muốn xóa label này\')" href="?action=delete&id=' . $result['idOrder'] . '&filename=' . $result['filename'] . '" class="btn btn-danger">Xóa</a></td>';
							echo "</tr>";
					}
						?>
						</tbody>
