    ...
    <div class="row">
        <div class="card">
            <div class="card-header text-center">
                <h3>UPLOAD TỆP VÀ TẢI TRACKING LÊN HỆ THỐNG</h3><a href="../../Dungchung/Excel/export-order.php" class="btn btn-primary">Tải xuống form Excel mẫu</a><br>
            </div>
                <div class="card-body ">  
                <?php 
                    ...
                    if ($_FILES['excel']['name']) {
                        ...
                        try {
                            ...
                            echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
                                    Tải lên tracking thành công! Đã cập nhật ' . $count . ' tracking.
                                    <span id="countdown" class="float-end"></span>';
                            }
                        } catch (Exception $e) {
                            echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">
